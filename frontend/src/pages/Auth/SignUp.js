...
const SignUp = ({ history, refetch }) => {
  ...
  return (
    <Root maxWidth="lg">
      ...
      <Welcome>
        <div>
          <Heading color="white">Connect with friends and the world around you about all things food.</Heading>
        </div>

        <p>See photos and updates from your friends about their food journey.</p>
        <p>Follow your favorite foodies.</p>
        <p>see peoples favorie recipes.</p>
      </Welcome>
